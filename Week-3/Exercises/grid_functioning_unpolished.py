...
#x coordinates when there are an even number of columns
if cols % 2 == 0:
    while col_count >= 1:
...
#x coordinates when there are an odd number of columns
if cols % 2 != 0:
    while col_count >= 1:
...
#creating a list of coordinate pairs by putting together all combinations of x and y coordinates
for h in range(rows):
    for i in range(cols):
        ls = []
...
#place squares at each set of coordinates
